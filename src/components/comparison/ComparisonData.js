...
export const ComparisonImages = [
  ...
  {
    id: 2,
    before: ImageTwoBefore,
    after: ImageTwoAfter,
  },
  {
    id: 3,
    before: ImageThreeBefore,
    after: ImageThreeAfter,
  },
];

export const ComparisonImagesTwo = [
  {
    id: 1,
    before: ImageFourBefore,
    after: ImageFourAfter,
  },
  {
    id: 2,
    before: ImageFiveBefore,
    after: ImageFiveAfter,
  },
  {
    id: 3,
